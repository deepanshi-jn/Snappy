...
const Logo = () => {
  return (
    <div className="flex p-5  justify-start items-center gap-2">
      ...
      <span className="text-3xl font-semibold ">Snappy</span>
    </div>
  );
};
...
const Title=({text})=>{
    return (
        <h6 className="uppercase pl-10 font-light text-opacity-90 text-sm tracking-widest text-neutral-400">{text}</h6>
    )
}